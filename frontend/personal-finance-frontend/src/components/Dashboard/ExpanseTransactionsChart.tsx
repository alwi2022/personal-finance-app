import { ArrowRight, TrendingDown, AlertCircle, Filter } from "lucide-react";
...
const ModernExpenseItem = ({ expense }: ModernExpenseItemProps) => {
  ...
  return (
    <div className="flex items-center justify-between p-3 bg-red-50 rounded-lg hover:bg-red-100 transition-colors">
      ...
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 bg-red-100 rounded-full flex items-center justify-center text-lg text-red-600">
          {expense.icon}
        </div>
